      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="cp-card-light p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <span className="cp-stat-chip">30 players</span>
            <span className="cp-stat-chip">2 min race</span>
            <span className="cp-stat-chip">3s countdown</span>
          </div>
          ...
          {advancedOpen ? (
            <div className="mt-6 rounded-[1.6rem] border border-slate-200 bg-white/[0.72] p-4">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div>
                  <div className="mb-2 text-sm font-semibold text-slate-600">Players</div>
                  <input className="cp-input" value="30" readOnly />
                </div>
                <div>
                  <div className="mb-2 text-sm font-semibold text-slate-600">Race (sec)</div>
                  <input className="cp-input" value="120" readOnly />
                </div>
                <div>
                  <div className="mb-2 text-sm font-semibold text-slate-600">Countdown</div>
                  <input className="cp-input" value="3" readOnly />
                </div>
              </div>
            </div>
          ) : null}
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            <button className="cp-button-primary min-w-[13rem] text-base">Host Game</button>
        ...
        <section className="cp-card-light p-8">
          ...
          <div className="mt-8 space-y-4">
            {["1. Enter the room code", "2. Pick your name and color", "3. Watch the host screen and race"].map((step) => (
          ...
          <button className="cp-button-secondary mt-7 w-full justify-center bg-slate-950 text-white">Join Game</button>
        </section>
      </div>
    </div>
  );
